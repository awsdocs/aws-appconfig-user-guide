...
1. After the test completes, view the log output\. Locate the AWS AppConfig Lambda extension version in the **Details of the Exection** section\. This version must match the required URLs for that version\. 
...
| China \(Bejing\) |  `arn:aws-cn:lambda:cn-north-1:615057806174:layer:AWS-AppConfig-Extension:52`  | 
